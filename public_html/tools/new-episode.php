...
if (isset($_POST['action'])) {
    ...
    $_POST['page_name'] = strtolower(str_replace(' ', '-', str_replace(array(':', '’', '\''), '', $_POST['display_title'])));
    $_POST['audio_file_name'] = str_replace(' ', '_', str_replace(array(':', '’', '\''), '', $_POST['display_title']));
    #
    ...
    <body>
        ...
        <form method="post" accept-charset="utf-8">
            ...
            <div class="form-item" id="publication_date_wrapper">
                ...
                <input class="topcoat-text-input--large" type="date" id="publication_date" name="publication_date" value="" placeholder="e.g., 2013-11-29" required>
            </div>
            <div class="form-item" id="description_wrapper">
                <label for="description">Description</label><br>
                <textarea class="topcoat-textarea" rows="2" id="description" name="description" placeholder="e.g., Jonathan and Kelli talk about yada yada yada..." required></textarea>
            </div>
